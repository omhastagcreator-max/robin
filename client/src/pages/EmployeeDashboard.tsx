...
export default function EmployeeDashboard() {
  ...
  const [newTask, setNewTask] = useState({ title: '', priority: 'medium', dueDate: '', taskType: 'dev', assignToId: '' });
  ...
  const handleCreateTask = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewTask({ title: '', priority: 'medium', dueDate: '', taskType: 'dev', assignToId: '' });
      setAddingTask(false);
        ...
        <div className="grid lg:grid-cols-3 gap-5">
          ...
          <div className="lg:col-span-2 space-y-3">
            ...
            {tasksLoading ? (
              ...
              <div className="bg-card border border-border rounded-2xl divide-y divide-border/50 overflow-hidden max-h-[520px] overflow-y-auto">
                {tasks.length === 0 && (
