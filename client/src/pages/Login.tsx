...
// DEMO_ACCOUNTS constant removed (June 2026) — the quick-fill chip grid
// was leaking real teammate emails + default passwords on the public
// login page. Owners can still sign in via the email/password fields
// or Google OAuth above.
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="bg-card border border-border rounded-2xl p-7 shadow-lg shadow-black/5">
          ...
          {/* Owner ask (June 2026): "remove the profiles from the landing
              page." The quick-access chip grid previously listed real
              teammates with their emails + reset default passwords, which
              is convenient for demo but is a credential-leak invitation
              in production. Removed entirely — login is now email +
              password (or Google) only. Setting a demo store back up is
              a one-liner if it's ever needed again. */}
        </div>
      </motion.div>
    </div>
  );
